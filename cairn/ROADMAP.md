...
_Last hygiene check: 2026-09-13 (M006 archived, M003 row pruned, one lesson added, validator clean, byte budgets within caps)_

## Milestones

| ID | Title | Status | Depends on | Priority | File/Archive |
|---|---|---|---|---|---|
| M006 | State of the field says why intraclass is a new package | done | — | normal | milestones/archive/M006-why-new-package.md |
