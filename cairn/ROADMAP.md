...
- Add rows to `analysis/comparison.R` for psych's estimates on `ratings_incomplete`, so the paper can say they differ from intraclass (psych ICC(1) 0.116 against 0.276 in a 2026-09-13 run) — added 2026-09-13 — M004 review F2
- In State of the field, say why intraclass is a new package and not a contribution to psych or irr, as current JOSS review guidance asks — added 2026-09-13 — M004 review F4
