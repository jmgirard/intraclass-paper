...
_Last hygiene check: 2026-09-10 (scaffold; nothing to check yet)_
...
- Draft the text from the package's comparison-with-other-packages article, with every reported number produced by a committed script against a named `intraclass` version — added 2026-09-10 — DESIGN Conventions
