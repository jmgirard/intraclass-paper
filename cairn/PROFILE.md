...
it, start it by hand. After the run concludes, download the PDF:
...
## changelog
none — the repository keeps no changelog; `/hotfix` skips the changelog entry
and the release-walk derives the version bump from git history.
