# CLAUDE.md — working guide for `intraclass-paper`

The companion JOSS software paper for the R package `intraclass`; see
`README.md` and `cairn/DESIGN.md`. The paper text is CC BY 4.0.
